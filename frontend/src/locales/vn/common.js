const TRANSLATIONS = {
  ...
  api: {
    title: "Khóa API",
    description:
      "API keys allow the holder to programmatically access and manage this ZexAiLLM instance.",
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your ZexAiLLM instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect your ZexAiLLM instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
