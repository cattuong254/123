...
import ZexAiLLMIcon from "@/media/logo/anything-llm-icon.png";
...
export const LLM_SELECTION_PRIVACY = {
  ...
  native: {
    ...
    description: [
      "Your model and chats are only accessible on this ZexAiLLM instance",
    ],
    logo: ZexAiLLMIcon,
  },
  togetherai: {
...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of ZexAiLLM",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "ZexAiLLM Embedder",
    description: [
      "Your document text is embedded privately on this instance of ZexAiLLM",
    ],
    logo: ZexAiLLMIcon,
  },
  openai: {
