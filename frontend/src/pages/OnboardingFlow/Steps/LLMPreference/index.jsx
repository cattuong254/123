...
const DESCRIPTION =
  "ZexAiLLM can work with many LLM providers. This will be the service which handles chatting.";
...
const LLMS = [
  ...
  },
  {
    ...
    description:
      "Use a downloaded custom Llama model for chatting on this ZexAiLLM instance.",
  },
];
...
export default function LLMPreference({
  ...
  const handleSubmit = async (e) => {
    ...
    // Default to ZexAiLLM embedder and LanceDB
